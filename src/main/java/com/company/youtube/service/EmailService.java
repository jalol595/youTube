...
import com.company.youtube.repository.EmailHistoryRepository;
...
//        sendSimpleEmail(toAccount, "Registration", message);
        String url = String.format("<a href='%sregister/email/verification/%s'>Verification Link</a>", serverUrl, token);
...
//    public void sendRegistrationEmail(String toAccount, String email, Integer id) {
//        String url = String.format("<a href='%sprofile/getById/"+email+"/%s'>Verification Link</a>", serverUrl,  id);
//        StringBuilder builder = new StringBuilder();
//        builder.append("<h1 style='align-text:center'>Salom Jiga Qalaysan</h1>");
//        builder.append("<b>Mazgi</b>");
//        builder.append("<p>");
...
//        builder.append("</p>");
//
//        sendEmail(toAccount, "update", builder.toString());
//    }
